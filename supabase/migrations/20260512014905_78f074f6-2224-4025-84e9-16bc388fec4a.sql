select cron.unschedule('verify-domains-every-5min');

select cron.schedule(
  'verify-custom-domains-15m',
  '*/15 * * * *',
  $$
  select net.http_post(
    url := 'https://gfxdpbitanyuaowhiwzc.supabase.co/functions/v1/verify-custom-domains',
