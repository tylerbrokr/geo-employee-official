      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button className="inline-flex items-center gap-1.5 text-sm text-primary border border-dashed border-primary/40 px-3 py-1.5 rounded-md hover:bg-primary/5 transition-colors">
