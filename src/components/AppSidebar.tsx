...
export function AppSidebar() {
  ...
  const initials = fullName
    ...
    .slice(0, 2)
    .toUpperCase();
  const subtitle = client?.brokerage || "GEO Client";
      ...
      >
        ...
        <nav className="flex-1 px-3 mt-2">
          ...
          <div className="space-y-0.5">
            <NavLink
              ...
              style={location.pathname === "/portal/account" ? { background: "linear-gradient(90deg, rgba(5,150,105,0.15) 0%, transparent 100%)" } : undefined}
            >
              {location.pathname === "/portal/account" && (
        ...
        <div className="px-3 mb-2">
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-sidebar-foreground hover:text-white hover:bg-white/[0.06] transition-all"
          >
        ...
        <div className="px-5 py-5 border-t border-white/[0.06] flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="text-[13px] font-medium text-white truncate">{fullName}</div>
